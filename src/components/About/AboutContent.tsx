...
const AboutContent: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        Hello, I’m Zaky! I’m dedicated to continuously expanding my knowledge
        and skills in <span className="font-bold">security & software development</span>{" "}
        and learning new technologies. I'm able to develop web applications, perform vulnerability assessments, penetration testing to identify weaknesses in systems,
